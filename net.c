/*
 ** net.c -- networking module c file
 ** set up networking and accept connections
*/
...
// declare global variable server_socket_fd
...
int net_accept_connection() {
	...
	new_fd = accept(server_socket_fd, (struct sockaddr *)&their_addr, &sin_size);
